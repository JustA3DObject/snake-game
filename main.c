...
int i,j,Field[N][M],x,y,Gy,Head,Tail,Game,Fruit,a,b,var,dir,score,HighScore,Speed;
...
void snakeInitialization(){
    ...
    x=N/2;y=M/2; Gy = y; Head = 5; Tail =1; Game = 0,Fruit = 0,dir='d',score=0,Speed = 99;
